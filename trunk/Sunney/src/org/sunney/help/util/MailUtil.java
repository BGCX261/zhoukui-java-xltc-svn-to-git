...
public class MailUtil {
	...
	public static void main(String[] args) {
		String[] cc = { "sunney2012@sina.cn" };
		String[] to = { "zhoukui@xunlei.com" };
		String content = "<html><head></head><body><img src=\"cid:Sunset.jpg\"/></body></html>";
		String subject = "测试JavaMail";
		MailUtil util = new MailUtil("sunney2012@sina.cn", false, null, null, false, null);
		util.addAttachment("D:\\temp\\test.txt");
		util.send("zhoukui@xunlei.com", to, cc, subject, content);
	}
	 ...
	 * SMTP auth with SSL
	 */
	public MailUtil(String smtpHost, final String username, final String password, String sslPort) {
	 ...
	 */
	public MailUtil(String smtpHost, final String username, final String password) {
	 ...
	 * All in one setting
	 */
	public MailUtil(String smtpHost, boolean needAuth, final String username, final String password, boolean isSSL, String sslPort) {
	 ...
	 * email body
	 */
	public void send(String fromAddress, String[] toEmailAddresses, String[] ccEmailAddresses, String subject, String content) {
	...
	private InternetAddress[] emailToInternetAddressArray(String[] email) throws AddressException {
		if (email == null) {
